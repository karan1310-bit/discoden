...
import Picture1 from '../../public/services/spin1.jpg';
import Picture2 from '../../public/services/spin.png';
  ...
  return (
    <div ref={container} className="container min-h-screen font-neue lg:mb-[4vh]">
            <div className="body px-6 md:px-12">
                <h1 className="m-0 mt-[10px] mb-3 text-2xl md:text-4xl leading-none uppercase" ref={title1}>360 video booth: </h1>
