...
import Picture1 from '../../public/services/ballon1.jpg';
import Picture2 from '../../public/services/ballon.png';
...
const images = [
    ...
    {
      src: Picture2,
      className: "left-[33vw] md:left-[55vw] border border-white top-[40vh] md:h-[60vh] md:w-[40vh] h-[45vh] w-[30vh] z-[2]",
    },
  ];
  ...
  return (
    <div ref={container} className="container min-h-screen font-neue lg:mb-[4vh]">
            <div className="body px-6 md:px-12">
                <h1 className="m-0 mt-[10px] mb-3 text-2xl md:text-4xl leading-none uppercase" ref={title1}>Ballon Decor: </h1>
